...
public class ScatterPlotChart extends ChartFactory {
  ...
  public static String draw(List<XYScatter> list, int picId, String title, String xLabel,
      String yLabel) {
    ...
    try {
      ...
      System.out.println("draw exception:{}" + ex);
      return "";
    }
  ...
  public static XYDataset createXYDataSet(List<XYScatter> dataList, String dataName) {
  ...
  public static JFreeChart createChart(XYDataset xydataset, List<XYScatter> dataList, String title,
      String xLabel, String yLabel) throws IOException {

    JFreeChart jfreechart =
        createScatterPlot(title, xLabel, yLabel, xydataset, PlotOrientation.VERTICAL, true, true,
            false);
  ...
  private static void initDataLabels(JFreeChart jfreechart, List<XYScatter> dataList) {
    ...
    for (XYScatter xyScatter : dataList) {
      XYPointerFrameAnnotation pointerAnnotation =
          new XYPointerFrameAnnotation(xyScatter.getLabel(), xyScatter.getX(), xyScatter.getY(),
              turnTop);
  ...
  private static void initBackGroundAndAxis(JFreeChart jfreechart) throws IOException {
    ...
    if (backgroundImage == null) {
      ...
      String backgroundImg = classpath + "/pic/back.png";
