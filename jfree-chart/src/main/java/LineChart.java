...
public abstract class LineChart {
  ...
  public String draw(String title, String xLabel, String yLabel, List<XYLine> lineList, int picId) {
  ...
  protected void initDefaultXYPlot(CategoryPlot plot) {
    ...
    domainAxis.setCategoryLabelPositions(
        CategoryLabelPositions.DOWN_45);// 横轴 lable 的位置 横轴上的 Lable 45度倾斜 DOWN_45
    // 设置Y轴
