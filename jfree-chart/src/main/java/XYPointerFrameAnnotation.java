...
public class XYPointerFrameAnnotation extends XYTextAnnotation
  ...
  public void draw(Graphics2D g2, XYPlot plot, Rectangle2D dataArea, ValueAxis domainAxis,
    ...
    Rectangle2D rectangle2D = TextUtilities
        .drawAlignedString(this.getText(), g2, (float) labelX, (float) labelY,
            TextAnchor.BASELINE_CENTER);
    //添加边框
    g2.setColor(Color.WHITE);
    g2.setStroke(new BasicStroke(1.0F));
    rectangle2D.setFrame(rectangle2D.getX() - 3, rectangle2D.getY() - 2, rectangle2D.getWidth() + 5,
