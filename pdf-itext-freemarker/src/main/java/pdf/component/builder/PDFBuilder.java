...
public class PDFBuilder extends PdfPageEventHelper {
  ...
  public PDFBuilder(PDFHeaderFooter headerFooterBuilder, Object data) {
    this(headerFooterBuilder, data, "ping_fang_light.ttf");
  }

  public PDFBuilder(PDFHeaderFooter headerFooterBuilder, Object data, String fontFileName) {
  ...
  public void onOpenDocument(PdfWriter writer, Document document) {
    ...
    try {
      ...
      String uri = PDFKit.class.getClassLoader().getResource("").getPath()+"pic/company.png";
